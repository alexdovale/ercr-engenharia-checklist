...
const UIRender = {
  ...
  buildPrintReport: (sectionsArray, signatureData, currentSeq, logoB64, cnpj) => {
    ...
    // 🔥 Agora cada item pode ter VÁRIAS fotos: pega todas as miniaturas do item
